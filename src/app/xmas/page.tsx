    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-900 to-slate-900">
      ...
      <div className="container mx-auto px-4 pb-20 max-w-5xl">
            ...
            <div className="pt-4">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-cyan-500/20 to-purple-500/20 border border-cyan-400/30 rounded-xl p-6 flex flex-col justify-center">
                  <p className="text-white/80 mb-3 font-medium">Package Deal</p>
                  <p className="text-sm text-white/70 mb-2">
                    Warmup + Main + Side
                  </p>
                  <p className="text-4xl font-bold text-white mb-2">750 NOK</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              ...
              <ul className="space-y-2 text-white/70 mb-4">
                ...
                <li className="flex gap-2">
                  <span className="text-cyan-300">•</span>
                  <span>Group matchplay until 10 players reach the target</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-cyan-300">•</span>
              ...
              <div className="bg-purple-500/10 border border-purple-400/30 rounded-lg p-5 space-y-4">
                <div>
                  ...
                  <p className="text-white/70 leading-relaxed">
                    ...
                    <strong className="text-white">7-5-3-1 scoring</strong>. Top
                    two in each group advance to the next round, continuing
                ...
                <div className="border-t border-white/10 pt-4">
                  ...
                  <ul className="space-y-2 text-white/70 text-sm">
                    <li className="flex gap-2">
                      <span className="text-purple-300">→</span>
                      <span>
                        Top seed from QUALIFICATION in each group chooses games
                        1 and 2
                      </span>
                    </li>
                    <li className="flex gap-2">
                    ...
                    <li className="flex gap-2">
                      <span className="text-purple-300">→</span>
                      <span>
                        Top seed from QUALIFICATION chooses start order on game
                        1
                      </span>
                    </li>
                    <li className="flex gap-2">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="space-y-3 pl-4 border-l-2 border-white/10">
                <p className="text-white/70 leading-relaxed">
                  <strong className="text-white">Access:</strong> We are located
                  in the basement of the shopping mall. The entrance is on the
                  right side of the building (when facing Kiwi). Walk around the
                  corner on the right into the little alley, and the door will
                  be on the left side.
                </p>
                <p className="text-white/70 leading-relaxed">
                  <strong className="text-white">Door:</strong> The door will be
                  open during tournament hours. If locked, contact us on{" "}
                  <a
                    href="/slack"
                    className="text-cyan-300 hover:text-cyan-200 underline transition-colors"
                  >
            ...
            <div>
              ...
              <div className="pl-4 border-l-2 border-white/10 space-y-3">
                <p className="text-white/70 leading-relaxed">
                  <strong className="text-white">Metro:</strong> Take Line 5 to{" "}
                  <strong className="text-white">Veitvet station</strong> (15
                  minutes from downtown Oslo).
                </p>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-8 pl-4 border-l-2 border-white/10">
                <div>
        ...
        <section className="mb-20">
          ...
          <div className="space-y-6">
            {/* Friday Schedule */}
            <div className="pl-4 border-l-2 border-cyan-400/50">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="text-white/70">
                    <span className="font-semibold text-white">Death Race</span>
            ...
            <div className="pl-4 border-l-2 border-purple-400/50">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-4">
                  ...
                  <span className="text-white/70">Tournament information</span>
                </div>
                <div className="flex gap-4">
                  <span className="font-mono text-purple-300 font-medium min-w-[100px]">
                    10:15-12:45
            ...
            <div className="pl-4 border-l-2 border-pink-400/50">
            ...
            <div className="pl-4 border-l-2 border-purple-400/50">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex gap-4">
                  ...
                  <span className="font-semibold text-white">Finals start</span>
                </div>
                <div className="flex gap-4">
                  <span className="font-mono text-purple-300 font-medium min-w-[100px]">
                    09:30-17:00
              ...
              <div className="bg-purple-500/10 border border-purple-400/30 rounded-lg p-4">
                <p className="text-white/70 text-sm">
                  See <strong className="text-white">Tournament Format</strong>{" "}
            ...
            <div className="pl-4 border-l-2 border-orange-400/50">
